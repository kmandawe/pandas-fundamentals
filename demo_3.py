...
df = pd.DataFrame.from_records(records, columns=["Coffee", "Price"])
print(df)
...
SAMPLE_JSON = os.path.join('/Users/kmandawe/data/pandas-fundamentals/', 'artworks', 'a', '000', 'a00001-1035.json')
...
def read_artworks_from_json(keys_to_use):
    ...
    directory.
    """
    JSON_ROOT = os.path.join('/Users/kmandawe/data/pandas-fundamentals/', 'artworks')
